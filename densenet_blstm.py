# coding:utf-8
'''
densenet+bilstm+ctc network
'''
from keras.models import Model
from keras.layers.core import Dense, Dropout, Activation, Reshape, Permute, Reshape
from keras.layers.convolutional import Conv2D, Conv2DTranspose, ZeroPadding2D
from keras.layers.pooling import AveragePooling2D, GlobalAveragePooling2D
from keras.layers import Input, Flatten, Bidirectional, LSTM
...
def dense_cnn(input, num_class=None):
	_dropout_rate = 0.2
	_weight_decay = 1e-4
	...
	x = Permute((2, 1, 3), name='permute')(x) #(b, None, 4, 192)
...
if __name__ == '__main__':
	input = Input(shape=(64, 400, 1), name='the_input')
	y_pred = dense_cnn(input, 30)
